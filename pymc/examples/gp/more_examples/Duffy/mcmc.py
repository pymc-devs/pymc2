"""
This example uses Markov chain Monte Carlo to sample from the posterior of the PyMC probability model declared in model.py, and visualizes the output as maps.
