...
\medskip
This package is bundled with the \pkg{PyMC} distribution in the directory \code{pymc/gp}, but is not a part of \pkg{PyMC}'s core and was not covered by \cite{pymc}. The version of \pkg{PyMC} to which this paper refers is available at \href{https://github.com/pymc-devs/pymc/tree/jss-gp}{https://github.com/pymc-devs/pymc/tree/jss-gp}. The SHA1 hash of this version is \code{8340c86bfac101c0d2a32ea5a8522395d59d3e92}. The \pkg{PyMC} user guide, available from the downloads page, provides instructions for installation of \pkg{PyMC} and use of the portions of the package not covered by this article. All examples can be found in the folder \code{pymc/examples/gp} in the source tree. 
